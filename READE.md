...
e administrativos de uma clínica médica. O projeto foi desenvolvido como elemento 
de consolidação prática para a cadeira de **Linguagem de Programação** do 2º Ano 
do curso de **Engenharia Informática** da **Universidade Kimpa Vita (UGE / Instituto Politécnico do Uíge)**.
...
A aplicação adota o padrão de arquitetura em camadas para isolar responsabilidades 
